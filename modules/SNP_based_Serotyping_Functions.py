...
def find_serotype(input_dir, fastq_files, serotypes, reference_directory, output_dir, bowtie_path, samtools_path, clean_bam, logger, workflow='', version = '', threads=4):
    """
    ...
    if unique != None:
        sorted_bamfile, reference_fasta_file = try_and_except(output_dir+"/logs/SNP_based_serotyping.stderr", bowtie_map.mapping, fastq, reference_fasta_file, bowtie_path, samtools_path, outdir, logger, threads)
